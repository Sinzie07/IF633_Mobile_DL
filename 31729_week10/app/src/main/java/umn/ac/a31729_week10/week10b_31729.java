...
public class week10b_31729 extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Void>  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week10b_31729);
    ...
    static class ContohLoader extends AsyncTaskLoader<Void> {
        static WeakReference<week10b_31729> mActivity;
        int mCounter = 0;
        public ContohLoader(@NonNull Context context, int n, week10b_31729 main) {
            super(context);
            mCounter = n;
            mActivity = new WeakReference<week10b_31729>(main);
        }
        @Nullable
        @Override
